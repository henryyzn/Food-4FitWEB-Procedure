...
<head>
    ...
    <title>Personal Fitness - Fit Session :: Food 4fit - CMS</title>
                    ...
                    <div class="saude-content" id="personal-lista">
                        ...
                        <table class="generic-table">
                            ...
                            <tr>
                                ...
                                <td><img src="../../assets/images/cms/symbols/editar.svg" alt="" onclick="javascript:location.href='add-pub-personal-fitness.php?modo=editar&id=<?php echo($lista[$i]->id)?>'" class="table-generic-opts"></td>
                                <td><img src="../../assets/images/cms/symbols/excluir.svg" alt="" onclick="javascript:location.href='add-pub-personal-fitness.php?modo=excluir&id=<?php echo($lista[$i]->id)?>'" class="table-generic-opts"></td>
                            </tr>
                            <?php
                                }
                            ?>
