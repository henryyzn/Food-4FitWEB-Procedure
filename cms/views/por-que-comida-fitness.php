...
<head>
    ...
    <title>Porquê a Comida Fitness - Fit Session :: Food 4fit - CMS</title>
            ...
            <div id="page-content">
                <div class="saude-wrapper">
                    <div class="saude-content" id="personal-lista">
                        <div id="page-actions">
                            <a href="add-pub-por-que-comida-fitness.php" id="btn-adicionar-publicacao">
                        ...
                        <table class="generic-table">
                            ...
                            <tr>
                                ...
                                <td><img src="../../assets/images/cms/symbols/excluir.svg" alt="" onclick="javascript:location.href='add-pub-por-que-comida-fitness.php?modo=excluir&id=<?php echo($lista[$i]->id)?>'" class="table-generic-opts"></td>
                            </tr>
                            <?php
                                }
                            ?>
