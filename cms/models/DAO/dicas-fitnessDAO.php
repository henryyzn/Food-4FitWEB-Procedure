...
class dicasFitnessDAO {
    ...
    public function selectId($id){
        ...
        p.texto AS texto, 
        p.data AS data,
        p.ativo AS ativo FROM tbl_personal_fitness AS p INNER JOIN tbl_dica_fitness AS f WHERE p.id_funcionario = f.id AND p.id = ".$id;
        ...
        $listDicasFitness->ativo = $rs['autor'];
