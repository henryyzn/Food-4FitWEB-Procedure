<?php
    ...
    class promocaoDAO {
        ...
        public function insert($classPromocao){
            ...
            $sql = "INSERT INTO tbl_promocao(id_prato, desconto, data_inicio, data_termino, ativo) values (
           ...
           // echo $sql;
            ...
            if($PDO_conex->query($sql)){
                ...
                echo "<script>alert('Erro ao inserir informações no sistema. Tente novamente ou contate o técnico.'); window.location = 'promocoes.php';</script>";
            }
        ...
        public function selectId($id){
            ...
            if($rs=$select->fetch(PDO::FETCH_ASSOC)){
                ...
                if($PDO_conex->query($sql))
                    ...
                    echo "<script>alert('Erro ao buscar informações no sistema. Tente novamente ou contate o técnico.'); window.location = 'promocoes.php';</script>";
        ...
        public function selectDouble(){
            ...
            //Cria um objeto array da classe Contato
                ...
                $listPromocao[$count]->resumo = $rs['resumo'];
                $listPromocao[$count]->descricao = $rs['descricao'];
                $listPromocao[$count]->prato_ativo = $rs['prato_ativo'];
                $listPromocao[$count]->promocao_ativo = $rs['promocao_ativo'];
                $listPromocao[$count]->descricao = $rs['descricao'];
                $listPromocao[$count]->foto = $rs['foto'];
        ...
        public function delete($id){
            ...
            if($PDO_conex->query($sql))
                ...
                echo "<script>alert('Erro ao excluir informações no sistema. Tente novamente ou contate o técnico.'); window.location = 'promocoes.php';</script>";
        }
