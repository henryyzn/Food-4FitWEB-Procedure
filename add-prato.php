<?php
    ...
    if(isset($_GET['btn-salvar'])){
        ...
        require_once('cms/models/pratoFotoClass.php');
        require_once('cms/models/DAO/pratoFotoDAO.php');
...
<head>
    ...
    <title>Adicionar Prato :: Food 4fit - CMS</title>
...
<body>
    <section id="main">
        <?php require_once("cms/components/sidebar.php") ?>
        <div id="main-content">
            <?php require_once("cms/components/navbar.php")?>
            <div id="page-content">
                    ...
                    <table class="generic-table">
                      ...
                      <div class="categoria-form-right">
                        <div class="form-generic border-30px">
                            <form action="cms/views/upload/upload-foto-prato.php" method="POST" name="frmfoto" id="frmfoto" class="form-generic-content" enctype="multipart/form-data">
